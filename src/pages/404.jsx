    ...
    return (
      <div>
        ...
        <div className='notfound'>
            ...
            <input style={{position: 'absolute', width: '1px', height: '1px', margin: '-1px', border: '0', padding: '0', clip: 'rect(0 0 0 0)', overflow: 'hidden'}} autoFocus onKeyPress={() => this.run()}></input>
        </div>
      </div>
    );
  }
